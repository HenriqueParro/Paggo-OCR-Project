    ...
    if (id) {
      const fetchDocumentDetails = async () => {
        try {
          ...
          const response = await axios.get(`https://paggo-ocr-project-production.up.railway.app/upload/document/${id}`, {
            headers: {
  ...
  const handleQuestionSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://paggo-ocr-project-production.up.railway.app/llm/ask',
        {
